...
\subsection{Storytelling as structured video recommendation}

The wePorter system not only makes it possible to delve into video items to detect local preferences, it also presents her output in a structured way, inherent to the medium of video.
